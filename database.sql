...
CREATE TABLE ADDRESSES (
	...
	additional_info varchar(128), -- including other address info such as Village, Hamlet, Quarter, Apartment...
    ...
    WHERE
        ...
        WHERE
            branch_id = (
                ...
                WHERE
                    VEHICLE.vehicle_id = vehicleID);
        INSERT INTO RENT (vehicle_id, trip_duration, customer_id, is_returned, date_rented)
